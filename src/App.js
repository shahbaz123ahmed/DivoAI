...
function HomePage() {
  ...
  return (
    <div className="min-h-screen text-slate-100 bg-[#111111] overflow-hidden">
      ...
      >
        <div className="container mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div className="hidden md:flex space-x-8 text-slate-300 font-medium">
            ...
            <Link to="/about" className="nav-link hover:text-white transition">
              About
            </Link>
            <Link
              to="/contact"
        ...
        <div
          className={`md:hidden mobile-menu-container mobile-menu-anim-style-${mobileMenuClickCount === 0 ? 1 : ((mobileMenuClickCount - 1) % 5) + 1} ${mobileMenuOpen ? "open" : ""}`}
        >
          <a
            href="#home"
        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <p className="text-slate-600 mt-4 text-lg">
              We design and construct bleeding-edge tech solutions to scale your
              product, improve security, and lead your industry.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Card 1 */}
            <div
              className="service-card-light p-8 flex flex-col justify-between"
              data-aos="fade-up"
              data-aos-delay="100"
            >
              <div>
                ...
                <p className="text-slate-600 leading-relaxed">
                  Stunning, lightning-fast, and SEO-optimized web experiences
                  designed to engage your visitors, drive sales, and establish a
            ...
            >
              <div>
                ...
                <h3 className="text-2xl font-bold text-slate-900 mb-3">
                  Develop Powerful Custom Software
                </h3>
                <p className="text-slate-600 leading-relaxed">
                  Tailored digital solutions built from the ground up to solve
                  your unique operational challenges, automate key workflows,
            ...
            >
              <div>
                ...
                <p className="text-slate-600 leading-relaxed">
                  Turn your ideas into profitable software platforms with secure
                  multi-tenant architectures, flexible subscription billing, and
            ...
            >
              <div>
                ...
                <p className="text-slate-600 leading-relaxed">
                  User-centric UI/UX design research, wireframing, and
                  interactive prototypes that turn complex systems into clean,
            ...
            >
              <div>
                ...
                <h3 className="text-2xl font-bold text-slate-900 mb-3">
                  Automate & Optimize Your Business
                </h3>
                <p className="text-slate-600 leading-relaxed">
                  Eliminate manual work by integrating smart APIs, cloud-based
                  workflows, and automated databases that save hours of team
                  labor daily.
                </p>
              </div>
              <div className="mt-8 flex items-center text-[#D90429] font-semibold group cursor-pointer text-sm">
            ...
            >
              <div>
                ...
                <h3 className="text-2xl font-bold text-slate-900 mb-3">
                  Complete IT Solutions & Support
                </h3>
                <p className="text-slate-600 leading-relaxed">
                  Proactive server maintenance, security auditing, daily
                  backups, and rapid-response technical troubleshooting to keep
            ...
            <div className="lg:col-span-6 space-y-8" data-aos="fade-right">
              ...
              The DivoAI Advantage
                ...
                <p className="text-slate-600 mt-6 text-lg leading-relaxed">
                  We don’t just develop software — we create high-performing
                  websites, scalable SaaS products, and smart digital solutions
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 text-sm mt-0.5">
                      Fast, secure, and scalable websites and software built
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 text-sm mt-0.5">
                      From idea to deployment, we handle design, development,
                      and scaling.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 text-sm mt-0.5">
                      Clean, intuitive interfaces that improve engagement and
                      user experience.
                    </p>
                  </div>
                </div>
            ...
            <div className="swiper-wrapper">
              ...
              >
                <div>
                  ...
                  <p className="text-slate-600">
                    "DivoAI reduced our cloud costs by 38% while
                    improving deployment speed." Rahul Mehta CTO • FinTech
                    Company"
                  </p>
                </div>
              ...
              >
                <div>
                  ...
                  <p className="text-slate-600">
                    "DivoAI delivered a scalable web application ahead of schedule with clean architecture and exceptional code quality. Their development team exceeded our expectations."
                  </p>
                </div>
                <div className="flex items-center gap-3 pt-6 border-t border-slate-100">
                  <div className="h-10 w-10 rounded-full bg-red-100 text-[#D90429] flex items-center justify-center font-bold text-sm">
              ...
              >
                <div>
                  ...
                  <p className="text-slate-600">
                    "DivoAI modernized our legacy system into a scalable cloud-native application, significantly improving performance and reducing maintenance overhead."
                  </p>
                </div>
                <div className="flex items-center gap-3 pt-6 border-t border-slate-100">
                  <div className="h-10 w-10 rounded-full bg-red-100 text-[#D90429] flex items-center justify-center font-bold text-sm">
      ...
      >
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <p className="text-slate-600 mt-4 text-lg">
              Stay ahead of technical innovation with strategies, workflows, and
              analyses curated by DivoAI IT architects.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {/* Blog Post 1 */}
            <div
              className="blog-card-light flex flex-col justify-between"
              data-aos="flip-left"
              data-aos-delay="100"
            >
              <div>
                ...
                <div className="p-6 space-y-3">
                  ...
                  <p className="text-slate-600 text-sm leading-relaxed">
                    Explore machine learning anomalies identification,
                    auto-healing Kubernetes nodes, and neural infrastructure
                    optimization.
                  </p>
                </div>
              </div>
            ...
            >
              <div>
                ...
                <div className="p-6 space-y-3">
                  ...
                  <p className="text-slate-600 text-sm leading-relaxed">
                    A deep dive into serverless database sharding, edge cache
                    rendering speeds, and cloud bill optimizations.
                  </p>
                </div>
              </div>
              <div className="px-6 pb-6 pt-2">
            ...
            >
              <div>
                ...
                <div className="p-6 space-y-3">
                  ...
                  <p className="text-slate-600 text-sm leading-relaxed">
                    How security architectures use strict identity
                    authorization, device certificates, and isolated networks.
                  </p>
                </div>
              </div>
              <div className="px-6 pb-6 pt-2">
      ...
      <section
        id="about"
        className="py-28 bg-[#F8FAFC] text-slate-900 relative border-t border-slate-100"
      >
        <div className="container mx-auto px-6">
          <div className="grid lg:grid-cols-12 gap-16 items-center">
            ...
            <div className="lg:col-span-7 space-y-6" data-aos="fade-left">
              ...
              <p className="text-slate-600 text-lg leading-relaxed">
                At DivoAI, we don’t just build software — we engineer scalable
                digital ecosystems. Since 2018, we’ve partnered with global
                businesses to design high-performance websites, custom software,
                and cloud-driven solutions that accelerate growth and
                innovation.
              </p>
              <p className="text-slate-600 text-lg leading-relaxed">
                By combining cutting-edge technology with intuitive user
                experiences, we help businesses move faster, scale smarter, and
          ...
          >
            <div className="text-center max-w-xl mx-auto mb-10">
              ...
              <div className="min-h-[96px] md:min-h-[80px] flex items-center justify-center mb-2 overflow-hidden">
                <h2
                  className={`text-3xl md:text-4xl font-black tracking-tight text-center gradient-text headline-${headlineIdx} ${headlineStatus}`}
                >
                  {headlines[headlineIdx]}
                </h2>
              </div>
              <p className="text-slate-400 mt-3">
                Have a vision for your next website, SaaS platform, or custom
                software? Share your goals with us — our team will help you
                design, build, and scale it with precision.
              </p>
            </div>
              ...
              >
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-slate-400 max-w-md mx-auto text-sm">
                    Thank you for reaching out to DivoAI. We have received your
                    inquiry and our tech architects will get back to you within
                    24 hours.
                  </p>
                </div>
                <button
              ...
              >
                ...
                {formStatus === "error" && (
                  <div className="col-span-full text-center text-red-400 text-xs font-semibold bg-red-500/10 border border-red-500/20 py-2.5 px-4 rounded-xl">
                    <i className="fas fa-exclamation-circle mr-2"></i> Something
                    went wrong. Please check your network or try again.
                  </div>
                )}
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-14">
            ...
            <div className="space-y-5 footer-col-1">
              ...
              <p className="text-sm leading-relaxed text-slate-500">
                ...
                tools, and intelligent IT systems tailored for today’s
                businesses. Every solution we create is designed to be fast,
          ...
          <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-slate-400 footer-bottom-bar">
            <p>
              ...
              — Building Digital Products That Scale. All rights reserved.
            </p>
      ...
      {whatsAppActive && (
        <div className="fixed bottom-6 right-6 z-[9999] flex flex-col items-end">
          ...
          <div
            className={`w-80 rounded-2xl bg-[#0F172A]/95 backdrop-blur-xl border border-white/10 shadow-2xl text-white overflow-hidden mb-4 transition-all duration-300 transform ${showWhatsAppPopup ? "opacity-100 translate-y-0 scale-100" : "opacity-0 translate-y-4 scale-95 pointer-events-none"}`}
          >
            {/* Header */}
            ...
            <div
              ref={chatBodyRef}
              className="p-4 bg-[#07090e]/80 max-h-[300px] overflow-y-auto text-left relative scroll-smooth"
            >
            ...
            <form
              onSubmit={(e) => {
                ...
                window.open(
                  `https://wa.me/917260912826?text=${encodedMsg}`,
                  "_blank",
                  "noopener,noreferrer",
                );
                setWhatsAppMessage("");
